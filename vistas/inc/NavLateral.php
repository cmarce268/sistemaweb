<section class="full-box nav-lateral">
	...
	<figure class="full-box nav-lateral-avatar">
		...
		<img src="<?php echo SERVERURL; ?> vistas/assets/avatar/Avatarm.jpg" class="img-fluid" alt="Avatar">
		<figcaption class="roboto-medium text-center">
			Marcela Garces <br><small class="roboto-condensed-light">Web Developer</small>
		</figcaption>
	</figure>
